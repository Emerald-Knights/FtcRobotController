...
public class Position extends Thread{
    ...
    private static double encoderToInch=1755; //will need to tune 1682
    private static double horizEncoderToInch=1663; //will need to tune
    final double horizEncoderToRadian= 889;//1697
    final double forwardEncoderToRadian = 1000; //3019
