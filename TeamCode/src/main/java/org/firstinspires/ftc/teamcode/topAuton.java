...
@Autonomous(name = "3RingsTop", group = "hmmm7")
public class topAuton extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        goGoal.add(new CurvePoint(-16,-60, Math.PI));
        goMid.add(new CurvePoint(2,-36,Math.PI));
        ...
        telemetry.update();
        if (cases == 1){
            goGoal.add(new CurvePoint(42, -18, Math.PI)); // 40, 15
        }
        else if (cases == 0){
        ...
        //40, 15
        boWei.followCurveSync(goMid, 8, 0.4,5);
